...
MAIN_HAL_SRC="./Drivers/STM32F3xx_HAL_Driver/Src"
MAIN_HAL_INC="./Drivers/STM32F3xx_HAL_Driver/Inc"
...
check_exist_f ${MAIN_LINKERS} STM32F3*.ld
check_exist_f ${MAIN_CMSIS_CORE} *.h
check_exist_f ${MAIN_CMSIS_DEV_INC} *.h
check_exist_f ${MAIN_CMSIS_DEV_SRC} system_stm32f3xx.c
check_exist_f ${MAIN_CMSIS_DEV_GCC} startup_stm32f3*.s
echo 
...
check_exist_f ${NEW_CMSIS_DEV_GCC_D} startup_stm32f3*.s
echo 
